...
namespace WCAE.WGUIs.Controls
{
    ...
    /// </remarks>
    public class WAngleHistogram : Control
    {
        #region Designer
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WAngleHistogram" /> control.
        /// </summary>
        public WAngleHistogram()
        {
            this.BackColor = WColorS_Dark.ColorGray78;
            InitializeComponent();
        }
