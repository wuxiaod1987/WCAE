namespace WCAE.WRenderer
{
    ...
    public class ScreenTrans
    {
        ...
        public ScreenTrans(bool invertY)
        {
            Level = -1;
        ...
        /// Mouse drag
        /// </summary>
        public bool MoveUpdate(float focusX, float focusY)
        {
            float width = Viewport.Width;
            float height = Viewport.Height;

            float x = Viewport.X - focusX * 0.05f;
            float y = Viewport.Y - focusY * 0.05f;
        ...
        public float WorldToScreen(float d)
        {
            return d / Viewport.Width * Screen.Width;
        }
