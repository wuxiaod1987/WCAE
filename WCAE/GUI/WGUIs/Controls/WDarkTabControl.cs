...
namespace WCAE.WGUIs.Controls
{
    ...
    /// </summary>
    public class WDarkTabControl : System.Windows.Forms.TabControl
    {
        #region Designer
        ...
        private Color backColor = WColorS_Dark.ColorGray68;

        /// <summary>
        /// Initializes a new instance of the <see cref="WDarkTabControl" /> control.
        /// </summary>
		public WDarkTabControl()
		{
        ...
        private void DrawTab(Graphics g, TabPage tabPage, int index)
		{
            ...
            g.FillRectangle(selected ? Brushes.DimGray : WColorS_Dark.BrushGray68, tabBounds);
