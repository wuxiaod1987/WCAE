namespace WCAE.WTriangle.IO.Views
{
    partial class MeshControlView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbSweepline = new WCAE.WTriangle.IO.Controls.DarkCheckBox();
            this.slMaxAngle = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.slMaxArea = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.slMinAngle = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.cbConformDel = new WCAE.WTriangle.IO.Controls.DarkCheckBox();
            this.cbConvex = new WCAE.WTriangle.IO.Controls.DarkCheckBox();
            this.cbQuality = new WCAE.WTriangle.IO.Controls.DarkCheckBox();
            this.SuspendLayout();
            // 
            // lbMaxArea
            // 
