namespace WCAE.WTriangle.IO
{
    partial class FormGenerator
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sliderParam3 = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.sliderParam2 = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.sliderParam1 = new WCAE.WTriangle.IO.Controls.DarkSlider();
            this.darkListBox1 = new WCAE.WTriangle.IO.Controls.DarkListBox();
            this.btnClose = new WCAE.WTriangle.IO.Controls.DarkButton();
            this.btnGenerate = new WCAE.WTriangle.IO.Controls.DarkButton();
            this.SuspendLayout();
            // 
            // lbParam1
            // 
