namespace WCAE.WGUIs.Controls
{
    ...
    /// </summary>
    public class WDarkCheckBox : ButtonBase
    {
        #region Designer
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WDarkCheckBox" /> control.
        /// </summary>
        public WDarkCheckBox()
        {
            this.BackColor = Color_Back; /// Color.FromArgb(76, 76, 76);
            InitializeComponent();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled)
            {
                ...
                brushOuter = new LinearGradientBrush(newRect, WColorS_Dark.ColorGray107, WColorS_Dark.ColorGray110, mode);
