...
{
    public partial class WCombo : Control
    {
        public WCombo()
        {
            InitializeComponent();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Ps[0] = new Point(textBox.Location.X + textBox.Width + 8, 7);
            Ps[1] = new Point(textBox.Location.X + textBox.Width + 16, 7);
            Ps[2] = new Point(textBox.Location.X + textBox.Width + 12, 14);
