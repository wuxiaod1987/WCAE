...
namespace WCAE.WGUIs.Controls
{
    ...
    /// </summary>
    public class WDarkToolStripRenderer : ToolStripRenderer
    {
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                e.ArrowColor = WColorS_Dark.ColorGray89;
            }
        ...
        {
            e.Graphics.FillRectangle(WColorS_Dark.BrushGray78, 0, 2, e.Item.Width, 1);
        }
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            if (e.Item.Enabled)
            {
                ...
                {
                    e.Graphics.FillRectangle(WColorS_Dark.BrushGray50, 0, 0, e.Item.Width, e.Item.Height);
                }
            }
        ...
        {
            e.Graphics.FillRectangle(WColorS_Dark.BrushGray50, e.AffectedBounds);
